...
add_shortcode( 'current_year', 'pro\Shortcodes\current_year' );
...
add_shortcode( 'button', 'pro\Shortcodes\button' );
...
add_shortcode( 'blockquote', 'pro\Shortcodes\blockquote' );
...
add_shortcode( 'hook', 'pro\Shortcodes\hook' );
...
add_shortcode( 'group_buttons', 'pro\Shortcodes\group_buttons' );
