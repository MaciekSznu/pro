		...
		<div class="gallery-lightbox-thumbnails">
			...
			<?php for ( $i = 0; $i < $gallery_length; $i++ ) : ?>
				<?php if ( ! empty( $gallery[ $i ]['image'] ) ) : ?>
					<a href="<?php echo esc_attr( '#' . $i ); ?>"  class="gallery-lightbox-thumb col-12 col-md-6 col-lg-4" aria-label="<?php esc_html_e( 'thumb trigger open lightbox', 'pro' ); ?>">
						<?php
		...
		<div class="gallery-lightbox">
			<button class="gallery-lightbox__close">
				...
				<span class="screen-reader-text">
					<?php esc_html_e( 'close lightbox', 'pro' ); ?>
				</span>
			</button>
